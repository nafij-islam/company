        ...
        <div className="card-flex">
          <Card className="main-card">
            ...
            <Card.Body>
              ...
              <Card.Text>MarkatePlace Hunting</Card.Text>
            </Card.Body>
          </Card>
          ...
          <Card className="main-card">
            ...
            <Card.Body>
              ...
              <Card.Text>Python Developer</Card.Text>
            </Card.Body>
          </Card>
          ...
          <Card className="main-card">
            ...
            <Card.Body>
              ...
              <Card.Text>Java Script Developer</Card.Text>
            </Card.Body>
          </Card>
          ...
          <Card className="main-card">
            ...
            <Card.Body>
              ...
              <Card.Text>Laravel Developer</Card.Text>
            </Card.Body>
          </Card>
          ...
          <Card className="main-card">
            ...
            <Card.Body>
              ...
              <Card.Text>Tailwind Developer</Card.Text>
            </Card.Body>
          </Card>
        </div>
      </Container>
